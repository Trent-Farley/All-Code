...
##Starting the game ###
screen_background = pygame.display.set_mode([1200,600])
...
bar1 = bar.convert()
bar1 = pygame.image.load("./AI_Character (3).jpg")
## The computer
bar2 = bar.convert()
...
speed_x, speed_y, speed_circ = 450., 250., 100.
...
# movement of circle
    ...
    computer_speed = speed_circ * time_sec -25
